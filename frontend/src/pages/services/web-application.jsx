...
export default function WebApplicationPage() {
  const features = [
    {
      ...
      description: 'Beautiful, mobile-first web applications that work seamlessly across all devices and browsers.',
    },
    {
      icon: Zap,
      title: 'Fast Performance',
      description: 'Optimized for speed and responsiveness to deliver an exceptional user experience.',
    },
    {
      icon: BarChart3,
      title: 'Analytics Integration',
      description: 'Track user behavior and performance metrics to continuously improve your application.',
    },
  ];
  ...
  const benefits = [
    ...
    'Secure payment and authentication integration',
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mb-8">
                Modern, scalable web applications designed to engage users and drive business growth with cutting-edge technology.
              </p>
              <a
                href="/contactus"
                className="
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-[#0048e5] mb-8 max-w-2xl mx-auto">
                Let's transform your vision into a powerful, user-friendly web application that delivers results.
              </p>
