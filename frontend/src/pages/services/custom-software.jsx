...
import { CheckCircle, Code, Zap, BarChart3 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Tailored solutions built to your exact specifications with scalable, maintainable code.',
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Optimized for speed and efficiency to handle your business demands at any scale.',
    },
    {
      icon: BarChart3,
      title: 'Data-Driven Insights',
      description: 'Integrated analytics and reporting to make informed business decisions.',
    },
  ];
